...
DEMO_SCRIPT_PATH="${DEMO_SCRIPT_PATH:-script/02_DemoCompareExisting.s.sol}"
DEMO_SCRIPT_TARGET="${DEMO_SCRIPT_TARGET:-DemoCompareExistingScript}"
...
forge script "${DEMO_SCRIPT_PATH}:${DEMO_SCRIPT_TARGET}" \
  --rpc-url "$RPC_URL" \
...
EXPLORER_TX_BASE_URL="$EXPLORER_TX_BASE_URL" ./scripts/print_broadcast.sh "$DEMO_SCRIPT_PATH" "$CHAIN_ID"
